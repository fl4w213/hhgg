...
vouchid = [config["vouchid"]]

paypalme = [config["paypalme"]]
...
def fingerprint_modification():
    properties = fingerprints[0]['x-super-properties'] = 'aWYgb3MubmFtZSA9PSAibnQiOg0KICAgIGN0eXBlcy53aW5kbGwua2VybmVsMzIuU2V0Q29uc29sZVRpdGxlVyhmIkJvb3N0IEJvdCIp'
    fingerprints.pop(0)
